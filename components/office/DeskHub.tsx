...
export function DeskHub({ blurred = false }: DeskHubProps) {
  ...
  return (
    ...
    >
      ...
      {/* Evidence board on wall */}
      <svg
        className="absolute right-[6%] top-[10%] h-[48%] w-[22%]"
        viewBox="0 0 160 180"
        aria-hidden
      >
        <rect x="8" y="8" width="144" height="164" rx="3" fill="#6b4f1d" stroke="#4a3512" strokeWidth="2" />
        ...
        <circle cx="50" cy="140" r="3" fill="#c0392b" />
        <rect x="28" y="32" width="40" height="30" rx="1" fill="#d4c4a0" opacity="0.5" stroke="#a09070" strokeDasharray="3 2" />
        <rect x="95" y="42" width="40" height="30" rx="1" fill="#d4c4a0" opacity="0.5" stroke="#a09070" strokeDasharray="3 2" />
        <rect x="55" y="85" width="50" height="35" rx="1" fill="#d4c4a0" opacity="0.5" stroke="#a09070" strokeDasharray="3 2" />
        {/* String */}
        <path d="M40 45 L120 55 L80 100 L50 140" fill="none" stroke="#c0392b" strokeWidth="1" opacity="0.6" />
      </svg>

      {/* Desk lamp */}
      <svg
        className="absolute left-[14%] top-[18%] h-[38%] w-[14%]"
        viewBox="0 0 80 120"
        aria-hidden
      >
      ...
      {/* Desk edge highlight */}
      <div
        className="absolute bottom-[38%] left-0 right-0 h-1"
        style={{ background: "linear-gradient(90deg, transparent, #6b5040, transparent)" }}
      />

      {/* Monitor */}
      <svg
        className="absolute left-[36%] top-[26%] h-[36%] w-[26%]"
        viewBox="0 0 200 150"
        aria-hidden
      >
        ...
        {/* Screen glow */}
        <rect x="26" y="16" width="148" height="93" rx="2" fill="url(#monitorGlow)" opacity="0.4" />
      ...
      >
        ...
        <line x1="20" y1="36" x2="80" y2="36" stroke="#b09870" strokeWidth="0.5" opacity="0.5" />
        <line x1="20" y1="46" x2="70" y2="46" stroke="#b09870" strokeWidth="0.5" opacity="0.5" />
      </svg>
      ...
      {/* Title watermark */}
      <div className="pointer-events-none absolute bottom-[6%] left-[4%] opacity-30">
        <p className="text-[10px] uppercase tracking-[0.3em] text-amber-200/60">Casefiles</p>
        <p className="text-[8px] text-slate-500">Late shift — criminalistics lab</p>
      </div>
    </motion.div>
  );
}
